"""Batch prediction for the CEUS-GRU branch."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate CEUS-GRU predictions for a directory of sequences.")
    parser.add_argument("--checkpoint", default="runs/ceus_gru/best.pt", help="Path to a trained CEUS checkpoint.")
    parser.add_argument("--input", required=True, help="Directory containing .txt or .npz sequences.")
    parser.add_argument("--output", default="reports/ceus_predictions", help="Directory for prediction outputs.")
