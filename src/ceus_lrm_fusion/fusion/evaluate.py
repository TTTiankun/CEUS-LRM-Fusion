"""Evaluate the neural LRM-Fusion branch and export publication-friendly outputs."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate the neural LRM-Fusion branch.")
    parser.add_argument("--checkpoint", default="runs/fusion/best.pt", help="Path to an LRM-Fusion checkpoint.")
    parser.add_argument("--config", default=None, help="Optional config override.")
    parser.add_argument("--output", default="reports/fusion", help="Evaluation output directory.")
